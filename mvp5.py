...
class MeteorTracker:
    ...
    def is_meteor_track(self, track):
        ...
        if len(points) < 3:
            if not is_collinear_ransac(points, threshold=4.0, min_inliers_ratio=0.8):
                if self.debug:
